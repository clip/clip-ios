...
extension Axis: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        default:
            self = .vertical
            clip_log(.error, "Unsupported axis: %@", value)
        }
    }
}
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch rawValue {
            ...
            case "small":
                self = .small
            default:
                clip_log(.error, "Unsupported content size category: %@", rawValue)
                self = .medium
        }
    }
}
...
extension TextAlignment: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        default:
            self = .center
            clip_log(.error, "Unsupported text alignment: %@", value)
        }
    }
}
...
extension HorizontalAlignment: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        case "trailing":
            self = .trailing
        default:
            clip_log(.error, "Unsupported horizontal alignment: %@", rawValue)
            self = .center
        }
    }
}
...
extension VerticalAlignment: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        case "top":
            self = .top
        default:
            clip_log(.error, "Unsupported vertical alignment: %@", rawValue)
            self = .bottom
        }
    }
}
...
extension Alignment: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        case "trailing":
            self = .trailing
        default:
            clip_log(.error, "Unsupported alignment: %@", rawValue)
            self = .center
        }
    }
}
...
extension Edge: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        default:
            self = .leading
            clip_log(.error, "Unsupported edge: %@", rawValue)
        }
    }
}
