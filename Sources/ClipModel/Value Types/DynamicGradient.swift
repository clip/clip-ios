...
public struct DynamicGradient: Decodable, Hashable {
    public var `default`: ClipModel.Gradient
    
    // The following gradients should be used, in given order of precedence, if their selectors match the environment.
    
    public var darkModeHighContrast: ClipModel.Gradient?
    
    public var darkMode: ClipModel.Gradient?
    
    public var highContrast: ClipModel.Gradient?
    
    public init(gradient: ClipModel.Gradient) {
