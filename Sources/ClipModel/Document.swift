...
public struct Document: Decodable {
    ...
    public init(id: Int, clipRevisionID: Int, nodes: [Node], initialScreenID: Screen.ID) {
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(id: id, clipRevisionID: clipRevisionID, nodes: nodes, initialScreenID: initialScreenID)
    }
}
